...
- README's selectable-CLI claim is intentionally narrower than the enum in
  code. OpenCode/Antigravity generic launch presence is not evidence for full
